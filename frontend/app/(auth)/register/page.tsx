...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        "Error al registrarse. Puede que el correo ya esté en uso o la contraseña sea muy débil (mínimo 6 caracteres)."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="relative hidden w-1/2 items-center justify-center bg-foreground lg:flex">
        <div className="relative z-10 px-16">
          ...
          <p className="mt-4 text-sm text-background/60 max-w-sm leading-relaxed">
            Únete a la plataforma que simplifica la gestión de proyectos
            con una experiencia moderna e intuitiva.
          </p>
        </div>
